...
export default function Search({setUser}: IUserProps) {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
            ...
            <TextField id="input-with-sx" label="Username" variant="standard" onChange={searchHandler} onKeyDown={handleKeyDown}/>
            <Button variant="contained" sx={{ ml: 2 }} onClick={getUser}>Search</Button>
        </Box>
)}